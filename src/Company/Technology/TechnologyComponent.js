...
<div id="container" style={{background:"white", padding:"5em", color:"black"}}>
	<div class="container">
		<div class="title">
			...
			<span class="">Better user experience is now derived from the speed of the application and as more customers start using a particular technology, companies have to strive towards scalability</span>
		</div>
		<div class="row">
		<div class="col-md-4">
